...
class Product implements AST
{
    ...
    public Quantity eval(Map<String,Quantity> env)
    {
        Quantity toReturn = left.eval(env).mul(right.eval(env));
        return toReturn;
    }
...
class Quotient implements AST
{
    ...
    public Quantity eval(Map<String,Quantity> env)
    {
        Quantity toReturn = left.eval(env).div(right.eval(env));
        return toReturn;
    }
...
class Power implements AST
{
    ...
    public Quantity eval(Map<String,Quantity> env)
    {
        Quantity toReturn = child.eval(env).pow(exponent);
        return toReturn;
    }
...
class Sum implements AST
{
    ...
    public Quantity eval(Map<String,Quantity> env)
    {
        Quantity toReturn = left.eval(env).add(right.eval(env));
        return toReturn;
    }
...
class Difference implements AST
{
    ...
    public Quantity eval(Map<String,Quantity> env)
    {
        Quantity toReturn = left.eval(env).sub(right.eval(env));
        return toReturn;
    }
...
class Negation implements AST
{
    ...
    public Quantity eval(Map<String,Quantity> env)
    {
        Quantity toReturn = child.eval(env).negate();
        return toReturn;
    }
...
class Normalize implements AST
{
    ...
    public Quantity eval(Map<String,Quantity> env)
    {
        Quantity toReturn = child.eval(env).normalize(env);
        return toReturn;
    }
...
class Define implements AST
{
    ...
    public Quantity eval(Map<String,Quantity> env)
    {
        ...
        Quantity toReturn = defn.eval(env);
